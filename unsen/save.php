...
<font size = 2px color="#000066" face="Verdana"><B>Данные для входа на сайт будут высланы на ваш электронный почтовый ящик. </B></font><br/>

<div align="center">
<form method ="POST" action="select_save.php" name = "form">
<font size = 2px color="#000066" face="Verdana"><B>Введите ваше ФИО</B></font><br/>

<input type ="text" name = "name"> <br/>
 
<font size = 2px color="#000066" face="Verdana"><B>Введите ваш e-mail</B></font><br/>

<input type ="text" name = "mail"/> <br/>

<input type ="submit" name = "ok" onClick="test(this.form)" value="получить данные"/> 
