...
<input type ="submit" name = "ok" onClick="test(this.form)" value="войти"/> 

<input type ="button" name = "reg" value="Перейти к регистрации" onclick = "window.location='reg.php'"/>
 
</form>
<a href = "save.php"><font  size = 1px color="#000066" face="Verdana"><B>Проблемы со входом</a></B></font>
</div>
</td>
