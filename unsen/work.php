...
<dl>
    <dt><font  size = 4px color="#d22820" face="Verdana"><B>
Швеи в цех. 
</B></font></dt>
    <dd><font  size = 2px color="#000066" face="Verdana"><B>
С опытом работы по пошиву спецодежды, униформы, рабочей одежды. График работы два через два, соц. пакет, оплата проезда, премиальные, в цеху есть холодильник, чайник, свч. 
</B></font></dd>
    <dt><font  size = 4px color="#d22820" face="Verdana"><B>
Швеи-надомницы.
</B></font></dt>
    <dd><font  size = 2px color="#000066" face="Verdana"><B>
С опытом работы по пошиву спецодежды, униформы, рабочей одежды. Работа с производственной машиной и оверлоком.
</B></font></dd>
</dl>
