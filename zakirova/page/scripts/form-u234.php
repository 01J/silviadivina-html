...
function emailFormSubmission()
{
	...
	$subject = 'Отправка Заказа звонка(Матрица финансовой силы)';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["custom_U255"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Телефон:</b></td><td>' . htmlentities($_REQUEST["custom_U237"],ENT_COMPAT,'UTF-8') . '</td></tr>';
